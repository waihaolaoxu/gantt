        ...
        <div class="el-tabs el-tabs--card over" style='margin-bottom:-1px;'>
            <div class="el-tabs__header" style='border:none;'>
                <div role="tablist" class="el-tabs__nav">
                    <div class="el-tabs__item fl is-active">指数排行</div>
                </div>
            </div>
        </div>
        <div class="list-body">
                        ...
                        <el-row :gutter="10" style='width:100%;'>
                            <el-col :sm="24" :md="24" :lg="12" :xl="12">
                                <div class="basicInfoRight">
                                    ...
                                    <div class="tipsCons" v-if="tipShow">
                                        ...
                                        <p style="font-size:13px;">
                                            <span>公司信息指数是</span>
                                            <span style="color:#009966;">{{_self.data.companyScore.base_info_score}}</span>
                                            <span></span>
                                        </p>
                                        <p style="font-size:13px;">
                                        ...
                                        <p style="font-size:13px;">
                                            <span>跟进指数是</span>
                                            <span style="color:#009966;">{{_self.data.companyScore.deal_score}}</span>
                                            <span></span>
                                        </p>
                                        <p style="font-size:13px;">
                                        ...
                                        <p style="font-size:13px;">
                                            <span>案例指数是</span>
                                            <span style="color:#009966;">{{_self.data.companyScore.subject_score}}</span>
                                            <span></span>
                                        </p>
                                        <p style="font-size:13px;">
                                        ...
                                        <p style="font-size:13px;">
                                            <span>线索成交指数是</span>
                                            <span style="color:#009966;">{{_self.data.companyScore.clue_done_score}}</span>
                                            <span></span>
                                        </p>
                                        <p style="font-size:13px;">
                            ...
                            <el-col :sm="24" :md="24" :lg="12" :xl="12">
                                <div class="tipsCons">
                                    ...
                                    <p style="font-size:13px;">
                                        <span>是指您在家居在线平台的信息完善排行情况，在平台的排行指数越高，曝光率越高</span>
                                    </p>
                                    <p style="font-size:13px;">
                                        <span>
                                            <br>
