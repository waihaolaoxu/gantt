        ...
        <div class="el-tabs el-tabs--card over" style='margin-bottom:-1px;'>
            <div class="el-tabs__header" style='border:none;'>
                <div role="tablist" class="el-tabs__nav">
                    <div class="el-tabs__item fl is-active">添加渠道商</div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        created() {
            ...
            if (this.$route.query.id) {
                this.getData();
                this.submitUrl = 'channeldealer/update'
            } else {
                this.submitUrl = 'channeldealer/create'
            }
            this.getTypeData()
        },
        methods: {
            // 获取渠道商详情
            getData() {
                this.$http.get('channeldealer/get', {
                        params: {
