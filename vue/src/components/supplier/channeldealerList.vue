<template>
    <el-form class="list-box">
        <el-tabs v-model="activeName2" type="card">
            <div class="list-body">
                <el-tab-pane label="渠道商列表" name="first">
                    <div class="list-header">
                        <el-form :inline="true" :model="query" size="small">
                            ...
                            <el-form-item>
                                <el-input  v-model="query.mobile" placeholder="请输入渠道商手机号"></el-input>
                            </el-form-item>
                            <el-form-item>
                        ...
                        <el-button icon="el-icon-plus" title="添加" size="mini" style="margin:0 0 15px 0;" @click="addSupperFn">添加渠道商
                        </el-button>
                    </div>
                    <el-table :data="data" style="width: 100%" v-if="data.length" size="mini">
                        <el-table-column prop="id" label="ID">
                        </el-table-column>
                        <el-table-column prop="name" label="渠道商名">
                        </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                var _self = this;
                this.$http.get('channeldealer/list', {
                        params: _self.query
                    })
                    .then(function (res) {
            ...
            // 编辑渠道商
            editSupperFn(id){
                this.$router.push({'path': 'addChanneldealer',query: {id: id}})
            },
            // 删除渠道商
            DeleteSupperList(id){
            ...
            // 添加渠道商按钮
            addSupperFn(){
                this.$router.push({'path': 'addChanneldealer'})
            }
        },
        components: {
            paging,
