    ...
    export default {
        ...
        created() {
            ...
            if (this.$route.query.id) {
                this.getData();
                this.submitUrl = 'supervisor/update'
            } else {
                this.submitUrl = 'supervisor/create'
            }
            this.getTypeData()
        },
        methods: {
