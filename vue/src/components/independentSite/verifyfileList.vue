<template>
    <el-form class="list-box">
        <el-tabs v-model="activeName2" type="card">
            <div class="list-body">
                <el-tab-pane label="站点验证文件" name="first">
                    <div class="list-header">
                        ...
                        <el-button icon="el-icon-plus" title="添加" size="mini" style="margin:0 0 15px 0;" @click="addFileFn">添加站点验证文件
                        </el-button>
                    </div>
