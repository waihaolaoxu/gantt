        ...
        <div class="el-tabs el-tabs--card over" style='margin-bottom:-1px;'>
            <div class="el-tabs__header" style='border:none;'>
                <div role="tablist" class="el-tabs__nav">
                    <span class="el-tabs__item fl" @click="$router.push({path:'engineer_info',query: {id: $route.query.id}})">工地明细</span>
                    <span class="el-tabs__item fl" @click="$router.push({path:'gongdi_analyse_sr',query: {id: $route.query.id}})">工地收入分析</span>
                    <span class="is-active el-tabs__item fl">工地支出分析</span>
                </div>
            </div>
        </div>
